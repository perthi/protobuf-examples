...
{
    vector<  eSEM_COMMAND_ID >  t = { eSEM_COMMAND_ID::BLINK_LED_ON, eSEM_COMMAND_ID::MOTOR_XY_SET_POSITION, eSEM_COMMAND_ID::MOTOR_XY_START_CONTINUOUS_TRANSLATION,
                                   eSEM_COMMAND_ID::MOTOR_XY_STOP_CONTINUOUS_TRANSLATION,  eSEM_COMMAND_ID::REQUEST_FW_VERSION, eSEM_COMMAND_ID::MOTOR_STEPPER_STOP_HARD, eSEM_COMMAND_ID::MOTOR_STEPPER_STOP_SOFT };
...
// REGISTER_TYPED_TEST_CASE_P( TestKFPBMessageSEMMsgCommonT, set_get_id,  set_get_id_serialize, set_get_prameters, serialization );
REGISTER_TYPED_TEST_CASE_P( TestKFPBMessageSEMMsgCommonT, set_get_id,  set_get_id_serialize );
