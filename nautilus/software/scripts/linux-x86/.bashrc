...
source $FERROTECH_HOME/software/scripts/linux-x86/setenv.sh

 
alias f='cd  $FERROTECH_HOME/software'
alias b='cd  $FERROTECH_HOME/software/build/x86/bin'
alias h='ssh -Y perthi@192.168.0.9'
...
export LD_LIBRARY_PATH=$FERROTECH_HOME/software/3rd-party/protobuf/lib:$LD_LIBRARY_PATH

export PATH=$FERROTECH_HOME/software/3rd-party/protobuf/bin:$PATH
export PATH=$FERROTECH_HOME/software/build/x86/bin:$PATH
export PATH=$FERROTECH_HOME/software/scripts/linux-x86:$PATH
